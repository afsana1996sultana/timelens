                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input class="form-control" id="wholesell_minimum_qty" type="number"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="short_descp_en" class="col-form-label font-weight-bold">Description (En):</label>
                                    <textarea name="short_description_en" id="short_descp_en" rows="2" class="form-control summernote" placeholder="Write Short Description in English">{{ $product->short_description_en }}</textarea>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="short_descp_bn" class="col-form-label font-weight-bold">Description (Bn):</label>
                                    <textarea name="short_description_bn" id="short_descp_bn" rows="2" class="form-control summernote" placeholder="Write Short Description in Bangla">{{ $product->short_description_bn }}</textarea>
                                </div>
