                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" id="api_key" type="hidden" name="api_key" placeholder="Write api key here" value="{{old('api_key')}}">
                                <input class="form-control" type="text" placeholder="R6001640623a9516bf1f71.13295352" value="">
                                @error('api_key')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
