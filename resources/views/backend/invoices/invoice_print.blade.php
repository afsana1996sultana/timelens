...
<body>
	<div>
	    ...
	    <div style="padding:0 1.5rem;">
			...
			<div style="font-size: 13px; text-align: center; margin: 10px 0px;">Developed By : <a target="_blank" style="text-decoration: none;font-weight: 700; margin-left: 5px;" href="https://codehouseit.com"> Codehouse IT</a>
			</div>
	    </div>
	</div>
</body>
