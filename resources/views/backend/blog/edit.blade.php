		                ...
		                <div class="col-md-12">
		                    <form method="post" action="{{ route('blog.update',$blog->id) }}" enctype="multipart/form-data">
		                        ...
		                        <div class="mb-4">
    			                    ...
    			                    <input class="form-control tags-input" type="text"name="tags[]" placeholder="Type and hit enter to add a tag" value="{{ $blog->tags }}">
    			                    <small class="text-muted d-block">This is used for search.</small>
    		                    </div>
    		                    
    		                    <div class="mb-4">
    	                          	<label for="description" class="col-form-label" style="font-weight: bold;">Blog Details:</label>
    	                            <textarea name="description" rows="2" cols="2" class="form-control summernote" placeholder="Write Long Description English">{{ $blog->description }}</textarea>
    	                        </div>
